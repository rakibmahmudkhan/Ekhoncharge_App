...
class GpOfferPage extends StatefulWidget {
  const GpOfferPage({super.key});

  @override
  State<GpOfferPage> createState() => _GpOfferPageState();
}

class _GpOfferPageState extends State<GpOfferPage> {
  @override
