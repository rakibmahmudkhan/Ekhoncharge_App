...
class MySendMoneyPage extends StatefulWidget {
  const MySendMoneyPage({super.key});

  @override
  State<MySendMoneyPage> createState() => _MySendMoneyPageState();
}

class _MySendMoneyPageState extends State<MySendMoneyPage> {
  @override
